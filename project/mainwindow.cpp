    ...
    , ui(new Ui::MainWindow)
{
    ...
    */
    ...
    if(QSysInfo::productType()=="macos"){ // mac
    ...
    ui -> line_username -> setStyleSheet("color:rgb(0,0,0); border: 0px; background-color:rgba(255,255,255,0.0)");
...
void MainWindow::on_loginButton_clicked()
{
    ...
    if(qry.exec("SELECT user_name FROM userTable WHERE user_name= '"+username+"'")){
        ...
        ui -> check_label -> setText("There is no existing account.");
        return;
    }
